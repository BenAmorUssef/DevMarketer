    ...
    <div class="card">
      <div class="card-content">
        ...
        <div class="field">
          ...
          <p class="control">
            <input class="input {{$errors->has('name') ? 'is-danger' : ''}}" type="text" name="name" id="name" placeholder="name" required
            value="{{old('name')}}">
          </p>
        ...
        <button class="button is-success is-outlined is-fullwidth m-t-30">
          Register
                ...
                <h5 class="has-text-centered m-t-20"><a href="{{route('login')}}" class="is-muted">Already have account?</a></h5>
